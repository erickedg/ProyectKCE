...
sqlite_file_name="../database.sqlite" #Se guarda el nombre de la base de datos
base_dir=os.path.dirname(os.path.realpath(__file__)) #Se va leer el directorio actual del archivo database
